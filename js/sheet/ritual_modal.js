...
export function ShowDescriptiveModal(title, description, nivel){
    player_data = getPlayerData()
    game_data = getGameData()
    ...
    ritual_title.textContent = title
    ritual_description.textContent = description
    ritual_nivel.textContent = map[nivel]
